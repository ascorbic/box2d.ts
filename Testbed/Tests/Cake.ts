...
export class Cake extends testbed.Test {
    ...
    constructor() {
        ...
        this.m_particleSystem.SetRadius(0.035 * 2); // HACK: increase particle radius
        {
            ...
            pd.shape = shape;
            // pd.flags = box2d.b2ParticleFlag.b2_colorMixingParticle; //testbed.Test.GetParticleParameterValue();
        ...
        for (let i = 0; i < 10; i++) {
            ...
            body.SetPositionXY(0 - 2 + i * 0.3, 4 - i * 0.2);
        }
    }
